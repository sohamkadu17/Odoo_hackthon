...
router.get('/cities', async (req, res) => {
    try {
        ...
        const cities = await searchService.searchCities(q, {
            country: country,
            region: region,
        });
        res.status(200).json({
...
router.get('/activities', async (req, res) => {
    try {
        ...
        const activities = await searchService.searchActivities(cityId, {
            type: type,
...
// Public Trip View
router.get('/trips/public/:tripId', async (req, res) => {
    try {
