...
const timeline = [
  {
    ...
    events: [
      ...
      { time: '11:30', title: 'Check-in: Solar do Castelo Boutique', type: 'Lodging', cost: '$180', image: 'https://picsum.photos/seed/15660/800/600' },
      { time: '14:00', title: 'Alfama neighborhood walk', type: 'Activity', cost: '$0', image: 'https://picsum.photos/seed/15822/800/600' },
      { time: '19:00', title: 'Dinner at Zé da Mouraria', type: 'Dining', cost: '$45', image: 'https://picsum.photos/seed/15172/800/600' },
    ],
  },
  {
    day: 'Day 2 — Jun 13',
    city: 'Lisbon',
    events: [
      { time: '09:30', title: 'Belém Tower & Jerónimos Monastery', type: 'Activity', cost: '$18', image: 'https://picsum.photos/seed/15558/800/600' },
      { time: '13:00', title: 'LX Factory market lunch', type: 'Dining', cost: '$30', image: 'https://picsum.photos/seed/15559/800/600' },
      { time: '16:00', title: 'Azulejo tile workshop', type: 'Activity', cost: '$65', image: 'https://picsum.photos/seed/15424/800/600' },
      { time: '20:00', title: 'Sunset sail on the Tagus', type: 'Activity', cost: '$45', image: 'https://picsum.photos/seed/15008/800/600' },
    ],
  },
  {
    day: 'Day 3 — Jun 15',
    ...
    events: [
      ...
      { time: '10:00', title: 'Pena Palace visit', type: 'Activity', cost: '$22', image: 'https://picsum.photos/seed/15444/800/600' },
      { time: '14:30', title: 'Quinta da Regaleira gardens', type: 'Activity', cost: '$18', image: 'https://picsum.photos/seed/15656/800/600' },
      { time: '19:00', title: 'Dinner at Tascantiga', type: 'Dining', cost: '$55', image: 'https://picsum.photos/seed/15509/800/600' },
    ],
  },
]
