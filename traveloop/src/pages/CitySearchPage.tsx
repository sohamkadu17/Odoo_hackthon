...
const cities = [
  { name: 'Lisbon', country: 'Portugal', rating: 4.9, trips: 342, tags: ['Culture', 'Food', 'History'], emoji: '🏰', trending: true },
  { name: 'Kyoto', country: 'Japan', rating: 4.8, trips: 298, tags: ['Temples', 'Culture', 'Food'], emoji: '⛩️', trending: false },
  { name: 'Copenhagen', country: 'Denmark', rating: 4.7, trips: 215, tags: ['Design', 'Food', 'Cycling'], emoji: '🧜', trending: true },
  { name: 'Santorini', country: 'Greece', rating: 4.9, trips: 387, tags: ['Beaches', 'Romance', 'Views'], emoji: '🌊', trending: false },
  { name: 'Montreal', country: 'Canada', rating: 4.6, trips: 178, tags: ['Food', 'Arts', 'Bilingual'], emoji: '🍁', trending: false },
  { name: 'Cape Town', country: 'South Africa', rating: 4.8, trips: 203, tags: ['Nature', 'Wine', 'Adventure'], emoji: '🦁', trending: true },
  { name: 'Seville', country: 'Spain', rating: 4.7, trips: 264, tags: ['Flamenco', 'Architecture', 'Tapas'], emoji: '💃', trending: false },
  { name: 'Chiang Mai', country: 'Thailand', rating: 4.6, trips: 192, tags: ['Temples', 'Food', 'Nature'], emoji: '🏯', trending: true },
  { name: 'Buenos Aires', country: 'Argentina', rating: 4.5, trips: 147, tags: ['Tango', 'Steak', 'Culture'], emoji: '🥩', trending: false },
]
    ...
    >
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {cities.map((city, i) => (
          ...
          >
            {/* Cover */}
            <div className="relative flex h-32 items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-5xl">
              {city.emoji}
              {city.trending && (
                <div className="absolute top-3 right-3 flex items-center gap-1 rounded-full bg-amber-400 px-2 py-0.5 text-xs font-bold text-amber-900">
                  🔥 Trending
                </div>
              )}
            </div>
