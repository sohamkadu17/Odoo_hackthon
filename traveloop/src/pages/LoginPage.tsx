          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <div className="space-y-4">
                ...
                <>
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      className="w-full rounded bg-[#f9f9f9] px-4 py-3.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-stone-500"
                      required
                    />
                    <input
                      type="text"
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded bg-[#f9f9f9] px-4 py-3.5 pr-11 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-stone-500"
                  required
                />
                <button
                  type="button"
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
              <Button 
                type="submit" 
                variant="primary" 
                className="w-full sm:w-32 rounded bg-stone-800 border-none shadow-md shadow-stone-800/20 hover:bg-stone-700"
              >
