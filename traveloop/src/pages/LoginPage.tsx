...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#fdfaf7] p-4 sm:p-8">
      ...
      >
        {/* Left Side: Blue Gradient with BG Image */}
        <div className="relative hidden w-5/12 flex-col items-center justify-center p-12 text-center text-white md:flex">
          ...
          <div className="absolute inset-0">
            ...
            />
            {/* The gradient overlay creating the blue effect similar to the sample */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/95 to-indigo-800/95 mix-blend-multiply" />
          </div>

          {/* Content over background */}
          <div className="relative z-10 flex flex-col items-center space-y-6">
            <h3 className="text-sm font-semibold tracking-[0.2em] uppercase text-blue-100">Welcome To</h3>
            ...
            <p className="mx-auto mt-4 max-w-[200px] text-sm leading-relaxed text-blue-50 font-medium tracking-wide">
